...
const Popper = forwardRef((props, ref) => {
  ...
  const [arrowEl, setArrowEl] = useState(props.arrowEl);
...
Popper.propTypes = {
  ...
  arrowEl: PropTypes.oneOfType([PropTypes.string, PropTypes.node, PropTypes.arrayOf(PropTypes.node)]),
