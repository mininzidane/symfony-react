...
function BidInformationInput({ value, minValue, onChange, delta, displayCurrencyGroup, disabled }) {
  ...
  if (!displayCurrencyGroup) {
    displayValue = value ? formatUsCurrency(value) : '$';
  }
  ...
  return (
    <div className={classes.root}>
      {displayCurrencyGroup && <span className={classes.currencyGroup}>$</span>}
...
BidInformationInput.propTypes = {
  ...
  displayCurrencyGroup: PropTypes.bool,
  disabled: PropTypes.bool,
};

BidInformationInput.defaultProps = {
  minValue: 1,
  displayCurrencyGroup: false,
  disabled: false,
};
