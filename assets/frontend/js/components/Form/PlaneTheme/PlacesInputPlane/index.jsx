...
import GeoLocationShape from '../../../../lib/propshapes/GeoLocationShape';
...
class PlacesInput extends Component {
  constructor(props) {
    ...
    this.handlePlacesInitEvent = this.handlePlacesInitEvent.bind(this);
  ...
  attachEventListener() {
    ...
    $el.addEventListener(this.googlePlaceService.placesInputInitializedEventName, this.handlePlacesInitEvent);
  }
  ...
  removeEventListener() {
    ...
    $el.removeEventListener(this.googlePlaceService.placesInputInitializedEventName, this.handlePlacesInitEvent);
  }
  ...
  handlePlacesInitEvent() {
    const { isFocused } = this.state;
    if (isFocused && this.googleInputRef.current) {
      this.googleInputRef.current.dispatchEvent(new Event('focus'));
    }
  }
  ...
  render() {
    const { id, label, name, className, error, touched, onClick, placeholder, disabled, isShowGoogleMapIcon, content } =
      this.props;
