...
const ActionsCellStyles = { align: 'right', style: { padding: '12px 14px 12px 8px', verticalAlign: 'middle' } };

function ActionsCell({ lot, hasMaxBid }) {
  ...
  if (isPrelim && Boolean(currentCustomerBid)) {
    return (
      <BidNow
        buyItNow={buyItNow}
