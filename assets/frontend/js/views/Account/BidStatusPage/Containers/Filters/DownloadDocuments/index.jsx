          ...
          <ButtonOutlined
            ...
            label={
              <div className={classes.icon}>
                <svg viewBox="0 0 20 21" width="20" height="21" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                ...
                <svg width="7" height="3" viewBox="0 0 7 3" fill="none">
                  <path
                    d="M-5.16561e-07 1.09661e-07L7 4.76837e-07L3.5 3L-5.16561e-07 1.09661e-07Z"
                    fill="currentColor"
                  />
                </svg>
              </div>
