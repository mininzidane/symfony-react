...
function GoogleLogin({ label, isDisabled }) {
  ...
  return (
    <a
      className={classnames(classes.button, 'is-google is-md ga-event-tracking js-track-event qa_google_button', {
        'is-disabled': isDisabled,
      })}
      href={RouterService.getRoute('googleConnect', targetParams)}
      data-step="abm_registration"
      data-substep="register_with_google_button_click"
      data-ga-event-name="GClick"
      data-ga-event-category="Google Registration"
      data-ga-event-label="GRegistration"
    >
