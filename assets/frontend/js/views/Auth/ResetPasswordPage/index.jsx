...
import ForgotPasswordLayout from 'frontend/js/views/Shared/Auth/_Shared/ForgotPasswordLayout';
...
function ResetPasswordPage() {
  ...
  async function onSubmit(values, { setSubmitting, setFieldError }) {
    ...
    try {
      ...
      RouterService.customRedirect(data.redirect || RouterService.getFullRoute('home'));
    } catch (error) {
  ...
  return (
    <ForgotPasswordLayout title={translations.title} subtitle={translations.subtitle} maxWidth={578}>
      <Formik
        initialValues={{
          newPassword: '',
